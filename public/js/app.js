$( document ).ready(function() {
    ...
    if(window.location.pathname == '/adminFeedback'){
        ...
        $(document).ready(function() {
              ...
              var infrastructureCount = data[0] ? parseInt(data[0].textContent) : 0 ;
              var cafeteriaCount = data[1] ? parseInt(data[1].textContent) : 0;
              var facultyCount = data[2] ? parseInt(data[2].textContent) : 0;
              var libraryCount = data[3] ? parseInt(data[3].textContent) : 0;
              ...
              function drawChart() {
                ...
                data.addRows([
                  ...
                  ['Cafeteria', cafeteriaCount],
                  ['Library', libraryCount],
                  ['Faculty', facultyCount]
                ]);

                // Set chart options
                var options = {'title':'NCI Feedback statistics',
                               'width':500,
                               'height':500};
